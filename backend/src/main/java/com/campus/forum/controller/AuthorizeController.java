...
import com.campus.forum.entity.vo.request.ConfirmResetVO;
import com.campus.forum.entity.vo.request.EmailRegisterVO;
import com.campus.forum.entity.vo.request.EmailResetVO;
...
public class AuthorizeController {
     ...
     * 请求邮件验证码
     * @param email 请求邮件
     * @param type 类型（register/reset/modify）
     * @param request 请求
     * @return 是否请求成功
     */
    @GetMapping("/ask-code")
